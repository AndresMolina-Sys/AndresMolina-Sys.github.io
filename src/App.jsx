...
function Icon({ name, className = '', label }) {
  ...
  switch (name) {
    ...
    case 'csharp': return <svg {...base} {...accessible}><title>C#</title><path d="M12 1.75 20.5 6.65v9.7L12 21.25l-8.5-4.9v-9.7L12 1.75Z" fill="currentColor" /><text x="12" y="15.05" fill="#0b0b0b" fontFamily="Arial, Helvetica, sans-serif" fontSize="7" fontWeight="900" textAnchor="middle">C#</text></svg>;
